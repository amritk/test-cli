...
## [0.4.0](https://github.com/amritk/test-cli/compare/v0.3.1...v0.4.0) (2026-09-18)
...
* **api:** Renamed SDK from `Asdasdsdasdsdsdsdsdsdsdsdsdsdsdsdsd` to `TestIt`.
* **api:** Renamed SDK from `TestingMeOut` to `Asdasdsdasdsdsdsdsdsdsdsdsdsdsdsdsd`.
...
* **api:** remove operation planets.list (+11 more changes) ([dfea136](https://github.com/amritk/test-cli/commit/dfea1363758665bd600fd19061f3e0928837c0cf))
* **api:** update SDK name ([a2a7161](https://github.com/amritk/test-cli/commit/a2a7161f0c7d5e0032f77cdbdb25ada93188ede8))
* **api:** update SDK name (+1 more change) ([81cd359](https://github.com/amritk/test-cli/commit/81cd3598c4c16d3ea8dade1f6c26438686ae4304))
...
* **api:** update generated SDK content ([5e0bb62](https://github.com/amritk/test-cli/commit/5e0bb627d5de5695d5a79fdd4000722b11f69e15))
